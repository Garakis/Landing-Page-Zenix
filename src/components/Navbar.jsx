...
export default function Navbar() {
    ...
    return (
        <nav aria-label="Navegação Principal" className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-zenix-bg/80 backdrop-blur-md border-b border-zenix-secondary' : 'bg-transparent'}`}>
